        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="flex items-center gap-2 mt-2">
              <span className="text-xs font-black text-emerald-650 flex items-center gap-1 bg-emerald-50 px-2 py-0.5 rounded-lg border border-emerald-100/80 shadow-3xs" title="실시간 댓글 수">
                💬 {totalComments}
              </span>
              <span className="text-xs font-black text-slate-700 flex items-center gap-1 bg-slate-100 px-2 py-0.5 rounded-lg shadow-3xs" title="네이버 공식 실측 방문수(조회수)">
                👁️ {avgViews}
              </span>
              <span className="text-xs font-black text-rose-600 flex items-center gap-1 bg-rose-50 px-2 py-0.5 rounded-lg border border-rose-100/80 shadow-3xs" title="실시간 공감 수">
                ❤️ {totalLikes}
              </span>
            </div>
          </div>
