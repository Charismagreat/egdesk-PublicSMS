    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center justify-between relative overflow-hidden group hover:shadow-md transition-shadow">
        <div className="space-y-1 z-10">
          ...
          <h3 className="text-2xl font-bold text-slate-800">{(materialCount ?? 0).toLocaleString()} 종</h3>
          <div className="flex flex-col gap-1 mt-1">
            <span className="text-[10px] text-slate-500 font-semibold bg-slate-50 px-2 py-0.5 rounded-md border border-slate-100/60 inline-block w-fit">
              실재고량: {totalMaterialStock.toLocaleString()} 개
            </span>
            <p className="text-xs text-indigo-650 font-bold bg-indigo-50/50 px-2 py-0.5 rounded-md inline-block w-fit">
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex items-center justify-between relative overflow-hidden group hover:shadow-md transition-shadow">
        <div className="space-y-1 z-10">
          ...
          <h3 className="text-2xl font-bold text-slate-800">{(productCount ?? 0).toLocaleString()} 종</h3>
          <div className="flex flex-col gap-1 mt-1">
            <span className="text-[10px] text-slate-500 font-semibold bg-slate-50 px-2 py-0.5 rounded-md border border-slate-100/60 inline-block w-fit">
              실재고량: {totalProductStock.toLocaleString()} 개
            </span>
            <p className="text-xs text-indigo-650 font-bold bg-indigo-50/50 px-2 py-0.5 rounded-md inline-block w-fit">
