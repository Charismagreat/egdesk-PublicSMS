              ...
              {tasksLoading ? (
                ...
                <div className="grid grid-cols-1 gap-2.5">
                  {activeTasks.map(t => (
                    <div 
                      key={t.id}
                      className="bg-white border border-slate-200/80 rounded-2xl p-4 shadow-xs flex items-center justify-between hover:border-slate-350 transition duration-200"
                    >
              ...
              {tasksLoading ? (
                ...
                <div className="grid grid-cols-1 gap-2.5">
                  {filteredCompletedTasks.map(t => (
                    <div 
                      key={t.id}
                      className="bg-white/70 border border-slate-200/50 rounded-2xl p-4 shadow-2xs flex items-center justify-between opacity-85 hover:border-slate-350 transition duration-200"
                    >
                      <div className="space-y-1 text-left">
