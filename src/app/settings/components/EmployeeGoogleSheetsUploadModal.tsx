...
import { 
  Globe, AlertCircle, CheckCircle2, X, Loader2, Users, RefreshCw, Check, ShieldCheck, AlertTriangle, Bookmark, List
} from "lucide-react";
...
export default function EmployeeGoogleSheetsUploadModal({
  ...
  const fetchPresetsList = async () => {
    try {
      const res = await apiFetch("/api/shared/google-sheets/presets?domain=employee");
