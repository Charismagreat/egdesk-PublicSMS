...
export const COLUMN_DEFINITIONS = {
  ...
  excel_accounts: [
    { name: 'id', type: 'TEXT', notNull: true },
    { name: 'bank_id', type: 'TEXT', notNull: true },
    { name: 'bank_name', type: 'TEXT' },
    { name: 'account_number', type: 'TEXT', notNull: true },
    { name: 'account_name', type: 'TEXT' },
    { name: 'balance', type: 'INTEGER', defaultValue: 0 },
    { name: 'currency', type: 'TEXT', defaultValue: 'KRW' },
  ],
  excel_bank_transactions: [
    { name: 'id', type: 'TEXT', notNull: true },
    { name: 'transaction_date', type: 'TEXT', notNull: true },
    { name: 'transaction_time', type: 'TEXT' },
    { name: 'description', type: 'TEXT' },
    { name: 'category', type: 'TEXT' },
    { name: 'memo', type: 'TEXT' },
    { name: 'deposit', type: 'INTEGER', defaultValue: 0 },
    { name: 'withdrawal', type: 'INTEGER', defaultValue: 0 },
    { name: 'balance', type: 'INTEGER', defaultValue: 0 },
  ...
  excel_card_transactions: [
    { name: 'id', type: 'TEXT', notNull: true },
    { name: 'account_id', type: 'TEXT' },
    { name: 'card_company_id', type: 'TEXT' },
    { name: 'card_number', type: 'TEXT' },
    { name: 'cardholder_name', type: 'TEXT' },
    { name: 'usage_type', type: 'TEXT' },
    { name: 'sales_type', type: 'TEXT' },
    { name: 'approval_date', type: 'TEXT', notNull: true },
    { name: 'time', type: 'TEXT' },
    { name: 'approval_number', type: 'TEXT' },
    { name: 'merchant_name', type: 'TEXT' },
    { name: 'amount', type: 'INTEGER', defaultValue: 0 },
    { name: 'status', type: 'TEXT' },
    { name: 'memo', type: 'TEXT' },
    { name: 'category', type: 'TEXT' },
    { name: 'receipt_url', type: 'TEXT' },
    { name: 'applied_rule_id', type: 'TEXT' },
  ],
  excel_hometax_invoices: [
    { name: 'id', type: 'TEXT', notNull: true },
    { name: 'issue_date', type: 'TEXT', notNull: true },
    { name: 'supplier_name', type: 'TEXT' },
    { name: 'buyer_name', type: 'TEXT' },
    { name: 'supply_amount', type: 'INTEGER', defaultValue: 0 },
    { name: 'tax_amount', type: 'INTEGER', defaultValue: 0 },
    { name: 'total_amount', type: 'INTEGER', defaultValue: 0 },
    { name: 'item_name', type: 'TEXT' },
    { name: 'invoice_type', type: 'TEXT' },
    { name: 'partner_business_number', type: 'TEXT' },
    { name: 'memo', type: 'TEXT' },
    { name: 'is_exempt', type: 'INTEGER', defaultValue: 0 },
  ],
  excel_hometax_cash_receipts: [
    { name: 'id', type: 'TEXT', notNull: true },
    { name: 'transaction_date', type: 'TEXT', notNull: true },
    { name: 'franchise_name', type: 'TEXT' },
  ...
  excel_finance_rules: [
    { name: 'id', type: 'TEXT', notNull: true },
    { name: 'natural_text', type: 'TEXT', notNull: true },
    { name: 'structured_json', type: 'TEXT' },
    { name: 'target_category', type: 'TEXT' },
    { name: 'is_active', type: 'INTEGER', defaultValue: 1 },
  ],
  crm_attendance: [
    { name: 'id', type: 'TEXT', notNull: true },
  ...
  crm_annual_leaves: [
    { name: 'id', type: 'TEXT', notNull: true },
    { name: 'operator_id', type: 'TEXT', notNull: true },
    { name: 'leave_type', type: 'TEXT', notNull: true },
  ...
  crm_operator_contract_settings: [
    ...
    { name: 'allow_weekly_holiday_paid', type: 'INTEGER', defaultValue: 1 },
  ...
  crm_operator_medical: [
    ...
    { name: 'treatment_start_date', type: 'TEXT' },
    { name: 'treatment_end_date', type: 'TEXT' },
    { name: 'hospital_name', type: 'TEXT' },
    { name: 'sick_leave_days', type: 'INTEGER', defaultValue: 0 },
    { name: 'work_limitations', type: 'TEXT' },
    { name: 'tenant_id', type: 'TEXT' },
  ],
  ...
  tax_invoices: [
    ...
    { name: 'invoice_type', type: 'TEXT' },
    { name: 'type', type: 'TEXT' },
    { name: 'invoice_kind', type: 'TEXT' },
    { name: '작성일자', type: 'TEXT' },
    { name: 'issue_date', type: 'TEXT' },
    { name: '승인번호', type: 'TEXT' },
    { name: 'approval_no', type: 'TEXT' },
    { name: '발급일자', type: 'TEXT' },
    { name: '전송일자', type: 'TEXT' },
    { name: '공급자사업자등록번호', type: 'TEXT' },
    { name: 'supplier_corp_num', type: 'TEXT' },
    { name: '공급자종사업장번호', type: 'TEXT' },
    { name: '공급자상호', type: 'TEXT' },
    { name: 'supplier_corp_name', type: 'TEXT' },
    { name: '공급자대표자명', type: 'TEXT' },
    { name: 'supplier_ceo_name', type: 'TEXT' },
    { name: '공급자주소', type: 'TEXT' },
    { name: '공급받는자사업자등록번호', type: 'TEXT' },
    { name: 'buyer_corp_num', type: 'TEXT' },
    { name: '공급받는자종사업장번호', type: 'TEXT' },
    { name: '공급받는자상호', type: 'TEXT' },
    { name: 'buyer_corp_name', type: 'TEXT' },
    { name: '공급받는자대표자명', type: 'TEXT' },
    { name: 'buyer_ceo_name', type: 'TEXT' },
    { name: '공급받는자주소', type: 'TEXT' },
    { name: '합계금액', type: 'INTEGER', defaultValue: 0 },
    { name: 'total_amount', type: 'INTEGER', defaultValue: 0 },
    { name: '공급가액', type: 'INTEGER', defaultValue: 0 },
    { name: 'supply_amount', type: 'INTEGER', defaultValue: 0 },
    { name: '세액', type: 'INTEGER', defaultValue: 0 },
    { name: 'tax_amount', type: 'INTEGER', defaultValue: 0 },
    { name: '전자세금계산서분류', type: 'TEXT' },
    { name: '전자세금계산서종류', type: 'TEXT' },
    { name: '발급유형', type: 'TEXT' },
    { name: '비고', type: 'TEXT' },
    { name: 'remark', type: 'TEXT' },
    { name: '영수청구구분', type: 'TEXT' },
    { name: '공급자이메일', type: 'TEXT' },
    { name: '공급받는자이메일1', type: 'TEXT' },
    { name: '공급받는자이메일2', type: 'TEXT' },
    { name: '품목일자', type: 'TEXT' },
    { name: '품목명', type: 'TEXT' },
    { name: 'item_name', type: 'TEXT' },
    { name: '품목규격', type: 'TEXT' },
    { name: '품목수량', type: 'TEXT' },
    { name: '품목단가', type: 'TEXT' },
    { name: '품목공급가액', type: 'INTEGER', defaultValue: 0 },
    { name: '품목세액', type: 'INTEGER', defaultValue: 0 },
    { name: '품목비고', type: 'TEXT' },
    { name: 'excel_file_path', type: 'TEXT' },
    { name: 'status', type: 'TEXT' },
    { name: 'memo', type: 'TEXT' },
  ],
  tax_exempt_invoices: [
  ...
  cash_receipts: [
    ...
    { name: '공급가액', type: 'INTEGER', defaultValue: 0 },
    { name: 'supply_amount', type: 'INTEGER', defaultValue: 0 },
    { name: '부가세', type: 'INTEGER', defaultValue: 0 },
    { name: 'tax_amount', type: 'INTEGER', defaultValue: 0 },
    { name: '봉사료', type: 'INTEGER', defaultValue: 0 },
    { name: '총금액', type: 'INTEGER', defaultValue: 0 },
    { name: 'total_amount', type: 'INTEGER', defaultValue: 0 },
    { name: '승인구분', type: 'TEXT' },
    { name: '발급수단', type: 'TEXT' },
    { name: '거래구분', type: 'TEXT' },
...
export const TABLES = {
  ...
  excel_accounts: {
    name: 'excel_accounts',
    displayName: '엑셀 수동 계좌 마스터',
    columns: COLUMN_DEFINITIONS.excel_accounts.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.excel_accounts.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  excel_bank_transactions: {
    name: 'excel_bank_transactions',
    displayName: '엑셀 수동 계좌 거래 내역',
    columns: COLUMN_DEFINITIONS.excel_bank_transactions.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.excel_bank_transactions.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  excel_card_transactions: {
    name: 'excel_card_transactions',
    displayName: '엑셀 수동 카드 승인 내역',
    columns: COLUMN_DEFINITIONS.excel_card_transactions.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.excel_card_transactions.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  excel_hometax_invoices: {
    name: 'excel_hometax_invoices',
    displayName: '엑셀 수동 홈택스 세금계산서 대장',
    columns: COLUMN_DEFINITIONS.excel_hometax_invoices.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.excel_hometax_invoices.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  excel_hometax_cash_receipts: {
    name: 'excel_hometax_cash_receipts',
    displayName: '엑셀 수동 홈택스 현금영수증 대장',
    columns: COLUMN_DEFINITIONS.excel_hometax_cash_receipts.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.excel_hometax_cash_receipts.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  excel_finance_rules: {
    name: 'excel_finance_rules',
    displayName: '엑셀 수동 카테고리 매핑 규칙',
    columns: COLUMN_DEFINITIONS.excel_finance_rules.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.excel_finance_rules.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  crm_attendance: {
    ...
    columns: COLUMN_DEFINITIONS.crm_attendance.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.crm_attendance.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  crm_annual_leaves: {
    ...
    columns: COLUMN_DEFINITIONS.crm_annual_leaves.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.crm_annual_leaves.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  crm_operator_leave_balances: {
    ...
    columns: COLUMN_DEFINITIONS.crm_operator_leave_balances.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.crm_operator_leave_balances.length,
    rowCount: 0,
  ...
  crm_company_events: {
    ...
    columns: COLUMN_DEFINITIONS.crm_company_events.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.crm_company_events.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  crm_operator_profiles: {
    ...
    columns: COLUMN_DEFINITIONS.crm_operator_profiles.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.crm_operator_profiles.length,
    rowCount: 0,
    uniqueKeyColumns: ["operator_id"],
  },
  crm_operator_contract_settings: {
    ...
    columns: COLUMN_DEFINITIONS.crm_operator_contract_settings.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.crm_operator_contract_settings.length,
    rowCount: 0,
    uniqueKeyColumns: ["operator_id"],
  },
  crm_operator_medical: {
    name: 'crm_operator_medical',
    displayName: '임직원 의료 대장',
    columns: COLUMN_DEFINITIONS.crm_operator_medical.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.crm_operator_medical.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  crm_operator_ai_briefing_histories: {
    ...
    columns: COLUMN_DEFINITIONS.crm_operator_ai_briefing_histories.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.crm_operator_ai_briefing_histories.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  tax_invoices: {
    name: 'tax_invoices',
    displayName: '홈택스 전자세금계산서 대장',
    columns: COLUMN_DEFINITIONS.tax_invoices.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.tax_invoices.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  tax_exempt_invoices: {
    name: 'tax_exempt_invoices',
    displayName: '홈택스 면세 전자계산서 대장',
    columns: COLUMN_DEFINITIONS.tax_exempt_invoices.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.tax_exempt_invoices.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  cash_receipts: {
    name: 'cash_receipts',
    displayName: '홈택스 현금영수증 대장',
    columns: COLUMN_DEFINITIONS.cash_receipts.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.cash_receipts.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
  ai_ocr_feedback_corrections: {
    name: 'ai_ocr_feedback_corrections',
    displayName: 'AI OCR 피드백 자율 교정 대장',
    columns: COLUMN_DEFINITIONS.ai_ocr_feedback_corrections.map(c => c.name),
    columnCount: COLUMN_DEFINITIONS.ai_ocr_feedback_corrections.length,
    rowCount: 0,
    uniqueKeyColumns: ["id"],
  },
} as const;
